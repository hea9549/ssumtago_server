...
conn = Bunny.new(:host => "expirit.co.kr", :vhost => "pushHost", :user => "ssumtago", :password => ENV["RabbitMQ_pwd"])
conn.start
...
requestSurvey = {surveyId: 1, version: "1.0.1", data: [{questionCode: "01000120001", answerCode: "02001001"},
