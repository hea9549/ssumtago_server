...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { content: @lecture.content, link: @lecture.link, title: @lecture.title, week: @lecture.week } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { content: @lecture.content, link: @lecture.link, title: @lecture.title, week: @lecture.week } }
